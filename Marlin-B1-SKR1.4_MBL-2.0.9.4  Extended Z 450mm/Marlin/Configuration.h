...
#define CONFIG_EXAMPLES_DIR "BIQU/B1 - SKR 1.4 Extended Z"
...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Luigisvc, BIQU B1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BIQU B1 Extended Z axis 450mm"
