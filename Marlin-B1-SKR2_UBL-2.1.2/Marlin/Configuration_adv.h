...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN PB5 //-1           // Set a custom pin for the controller fan
  #define CONTROLLER_FAN2_PIN PB6 //-1          // Set a custom pin for second controller fan
...
//#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  //#define USE_OCR2A_AS_TOP
    ...
    #else
      #define FAST_PWM_FAN_FREQUENCY 60000U
    #endif
  #endif
#endif
